...
- [セッションのセキュリティ監査に関する主要な実装機能](#セッションのセキュリティ監査に関する主要な実装機能)
...
主な認証方式である「セッションベース認証」と「トークンベース認証(JWT)」のうち、本アプリは **セッションベース認証** を採用しました。
...
## セッションのセキュリティ監査に関する主要な実装機能

**セッションのセキュリティ監査** というテーマで一貫させた4つの機能を実装しました。
